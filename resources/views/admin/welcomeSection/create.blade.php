...
<div class="content-header">
     <div class="container-fluid">
          <div class="row mb-2">
               <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Create Welcome Section</h1>
               </div><!-- /.col -->
               <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                         <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                         <li class="breadcrumb-item"><a href="#">Welcome Section</a></li>
                         <li class="breadcrumb-item active">Create Welcome Section</li>
                    </ol>
               </div><!-- /.col -->
          </div><!-- /.row -->
     </div><!-- /.container-fluid -->
          ...
          <div class="row">
               <div class="col-12">
                    <div class="card card-primary">
                         ...
                         <form role="form" action="{{ route('admin.welcomesection.store') }}" method="post"
